  ...
  return (
    <div className='bg-white border-[.5px] rounded-lg py-4 mb-5'>
      <div className='w-[90%] mx-auto'>
        ...
        {numberLeft? <button className='bg-Moderate-cyan hover:bg-Dark-cyan rounded-full px-7 py-3 text-white text-sm font-bold'>Select Reward</button> : <button className='bg-Dark-gray rounded-full px-7 py-3 text-white text-sm font-bold'>Out of Stock</button> }
      </div>
    </div>
  )
}
