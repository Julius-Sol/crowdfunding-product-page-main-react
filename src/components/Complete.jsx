...
export default function Complete(props) {
  return (
    <div className={`${props.showComplete? "" : "hidden"} fixed flex flex-col -translate-x-1/2 left-[50%] w-[90%] mt-[8rem] py-3 px-5 bg-white items-center justify-center rounded-lg z-50 tablet:max-w-[500px]`}>
