...
export default function Complete(props) {
  return (
    <div className='fixed flex flex-col -translate-x-1/2 left-[50%] w-[90%] mt-[8rem] py-3 px-5 bg-white items-center justify-center rounded-lg'>
      ...
      <button className='bg-Moderate-cyan rounded-full text-white px-7 py-3 mb-8'>Got it!</button>
    </div>
  )
}
